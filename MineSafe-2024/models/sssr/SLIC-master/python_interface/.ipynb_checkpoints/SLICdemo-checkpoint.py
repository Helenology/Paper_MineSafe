...
def segment(imgname,numsuperpixels,compactness,doRGBtoLAB):
	...
	#--------------------------------------------------------------
	lib = cdll.LoadLibrary('/mnt/MineSafe-2024/models/sssr/SLIC-master/python_interface/libslic.so')
	start = timer()
...
def slicdemo():
	...
	imgname = "/mnt/MineSafe-2024/models/sssr/SLIC-master/python_interface/bee.png"

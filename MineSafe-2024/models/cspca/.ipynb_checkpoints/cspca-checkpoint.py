...
class CSPCA:
    ...
    def L1_PCA(self, max_iter=100):
        """
        Here, we implement the L1-PCA by directly using the RPCA algorithm.
        :return:
        """
        rpca_model = R_pca(self.Y)
        L, S = rpca_model.fit(max_iter=max_iter, iter_print=50)
        return L, S

    def TV_minimization(self, Z):
        """
    ...
    def fit(self, tol=None, max_iter=1000, iter_print=100):
        ...
        L = self.TV_minimization(Y_L)  # frame-by-frame background scene reconstruction from (24)

        # Part C: Moving Object Extraction
        X = self.TV_minimization()                    # frame-by-frame CS reconstruction from (27)
